...
RUN mkdir -p $LEIN_INSTALL \
  ...
  && gpg --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-key 2B72BF956E23DE5E830D50F6002AF007D1A7CC18 \
...
#
RUN apt-get update && \
    apt-get install -y nginx chromium-browser jq netcat rsync
